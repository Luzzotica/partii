...
const TIERS = [
  {
    ...
    rows: ["1 project, 1 API key", "120 rooms/hour", "50 concurrent rooms", "600 signals/min", "5 GB relay bandwidth/mo", "Player accounts + cloud saves: 200 items / 100 MB"],
  ...
  },
  {
    ...
    rows: ["Unlimited projects & API keys", "1,200 rooms/hour", "500 concurrent rooms", "6,000 signals/min", "25 GB relay bandwidth/mo per project", "Player accounts + cloud saves: 10,000 items / 5 GB"],
